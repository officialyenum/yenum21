    ...
    <div className="relative overflow-hidden bg-gray-800">
        <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
            ...
            <div>
                ...
                <button onClick={handleNavClick} className="inline-block rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-center font-medium text-white hover:bg-indigo-700">Get Started With Summarize</button>
                </div>
            </div>
            </div>
        </div>
